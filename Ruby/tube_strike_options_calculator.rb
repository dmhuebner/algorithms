...
def calculator(distance, bus_drive, bus_walk)
  ...
  fastest_option = nil
  walk_time_min = (distance / $walk) * 60
  bus_time_min = ((bus_drive / $bus) + (bus_walk / $walk)) * 60

  if walk_time_min == bus_time_min
    fastest_option = "Walk"
  elsif walk_time_min < 10
    fastest_option = "Walk"
  elsif walk_time_min > 120
    fastest_option = "Bus"
  elsif walk_time_min > bus_time_min
    fastest_option = "Bus"
  elsif walk_time_min < bus_time_min
    fastest_option = "Walk"
  end
